...
<table align="center" width="600" border="1">
	...
	<tr align="center" bgcolor="orange">
		<td>${cart.goodsNum }	</td>
		<td><img src = "Goods/upload/${cart.goodsImage }" width="30"/></td>
		<td>${cart.goodsName }</td>
		<td>${cart.goodsPrice }</td>
		<td><a href="goodsCartQtyUp.gd?goodsNum=${cart.goodsNum }"> + </a> 
		 ${cart.qty } 
		<a href="javascript:checkQty('${cart.goodsNum }',${cart.qty })"> - </a></td>
		<td align="center">
		<input type="checkbox" name="delete" value="${cart.goodsNum }" />
		</td>
	</tr>	
	</c:forEach>
</table>
