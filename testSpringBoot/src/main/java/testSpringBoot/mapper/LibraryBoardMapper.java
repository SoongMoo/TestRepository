...
public interface LibraryBoardMapper {
	...
	public void libContentUpdate(LibraryBoardDTO libraryBoardDTO)throws  Exception;
	public int libContenfileUpdate(LibraryBoardDTO libraryBoardDTO)throws  Exception;
}
