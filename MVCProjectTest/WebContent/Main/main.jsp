...
<tr><td>아이디</td>
    <td><input type ="text" id="id1" name="id1" value="${isId }" />
    	<div id ="idmsg">${failId }</div>
    </td>
	<td><input type="checkbox" name="idStore" 
		 value="store" 
		 <c:if test="${isCheck }"> checked</c:if> />
		아이디체크</td>
</tr>
<tr><td>비밀번호</td>
...
<a href ="board.bd">공지사항 게시판</a>
<a href ="library.lb">일반 자료실</a>
<a href ="answerBoard.ab">답변형 게시판</a>
<a href ="commentBoard.cb">댓글 게시판</a>
<a href ="goodsList.gd">상품목록</a>
<a href="mailForm.nhn">메일전송</a>
</c:if>
</body>
</html>